...
const HostList = (props: PropsDataTypes) => {
  return (
    <label className="flex flex-col h-full">
      ...
      <select form={props.formName} name="hosts" onChange={props.onChange} value={[props.selectedHost]} multiple className="flex-grow px-4 py-3 rounded w-3/4 focus:ring-0">
        {
